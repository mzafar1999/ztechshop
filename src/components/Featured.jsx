...
import { TitleWrapper, Title, SubTitle, Col, NavLink } from "./styledComponents";
        ...
        <Row className="row">
          {featureddata.map((item, i) => {
            return (
              <Container
                key={i}
                className=" d-flex column align-items-center col-md-4 col-12 my-3 "
              >
                <CardWrapper>
                  <ImageWrapper>
                    <NavLink to={`/`}>
                  ...
                  <Row>
                    <Row className="d-flex justify-content-between px-3 mt-2">
                      <StarDiv className="">
                        <ReactStars edit={false} size={30} value={item.rating} />
                      </StarDiv>
                      <Col className="h3 mt-2">{item.price}$</Col>
                    </Row>
                    <DetailsWrapper className="p-3 d-flex flex-column justify-content-around">
                      ...
                      <Reviews>Reviews {`(${item.reviews})`}</Reviews>
                    </DetailsWrapper>
                  </Row>
                </CardWrapper>
              </Container>
